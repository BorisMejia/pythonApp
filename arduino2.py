...
class Aplicacion:
    ...
    def recibir_datos_arduino(self):
        ...
        try:
            ...
            return None """
    def recibir_datos_arduino_simulado(self):
        # Simula datos desde Arduino (puedes ajustar según tus necesidades)
        datos_simulados = '80','1.70'  # Cambia esto según el formato de tus datos
    ...
    def add_peso(self):
      datos_arduino = self.recibir_datos_arduino_simulado()
      if datos_arduino:
